# @jtfox/prettier-config

jtfox로 prettier 설정을 사용합니다.

## 설치 방법

```bash
npm install @jtfox/prettier-config -D
```

## 사용 방법

.prettierrc 파일을 생성하고 `@jtfox/prettier-config` 패키지를 추가합니다.
...
```json
"prettier": "@jtfox/prettier-config"
```
